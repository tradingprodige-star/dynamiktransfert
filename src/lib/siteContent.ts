...
export const SITE_TEXT_FIELDS: SiteTextField[] = [
  ...
  {
    key: "home.service.crypto.eyebrow",
    page: "Accueil — services",
    label: "Service crypto — petit titre",
    defaultValue: "Crypto → FCFA",
  },
  {
    key: "home.service.crypto.title",
    page: "Accueil — services",
    label: "Service crypto — titre",
    defaultValue: "Payer en crypto, recevoir sur Mobile Money.",
  },
  {
    key: "home.service.crypto.text",
    page: "Accueil — services",
    label: "Service crypto — description",
    defaultValue: "Un tunnel clair pour créer une demande USDT/BTC vers T-Money, Moov, MTN, Orange ou Wave, avec référence et validation humaine.",
    multiline: true,
  },
  {
    key: "home.service.crypto.stat",
    page: "Accueil — services",
    label: "Service crypto — repère",
    defaultValue: "USDT / BTC",
  },
  {
    key: "home.service.crypto.bullet1",
    page: "Accueil — services",
    label: "Service crypto — puce 1",
    defaultValue: "Togo, Bénin, Burkina, Côte d’Ivoire",
  },
  {
    key: "home.service.crypto.bullet2",
    page: "Accueil — services",
    label: "Service crypto — puce 2",
    defaultValue: "Référence de paiement générée",
  },
  {
    key: "home.service.crypto.bullet3",
    page: "Accueil — services",
    label: "Service crypto — puce 3",
    defaultValue: "Validation finale par WhatsApp",
  },
  {
    key: "home.service.referral.eyebrow",
    page: "Accueil — services",
    label: "Service parrainage — petit titre",
    defaultValue: "Parrainage",
  },
  {
    key: "home.service.referral.title",
    page: "Accueil — services",
    label: "Service parrainage — titre",
    defaultValue: "Transformez vos recommandations en récompenses.",
  },
  {
    key: "home.service.referral.text",
    page: "Accueil — services",
    label: "Service parrainage — description",
    defaultValue: "Créez votre code parrain, partagez votre lien et suivez vos récompenses avec l’équipe DYNAMIK.",
    multiline: true,
  },
  {
    key: "home.service.referral.stat",
    page: "Accueil — services",
    label: "Service parrainage — repère",
    defaultValue: "150 pts",
  },
  {
    key: "home.service.referral.bullet1",
    page: "Accueil — services",
    label: "Service parrainage — puce 1",
    defaultValue: "Points par transfert",
  },
  {
    key: "home.service.referral.bullet2",
    page: "Accueil — services",
    label: "Service parrainage — puce 2",
    defaultValue: "Cashback et bonus",
  },
  {
    key: "home.service.referral.bullet3",
    page: "Accueil — services",
    label: "Service parrainage — puce 3",
    defaultValue: "Statut VIP",
  },
  {
    key: "home.service.partners.eyebrow",
    page: "Accueil — services",
    label: "Service partenaires — petit titre",
    defaultValue: "Partenariats",
  },
  {
    key: "home.service.partners.title",
    page: "Accueil — services",
    label: "Service partenaires — titre",
    defaultValue: "Codes partenaires et influenceurs faciles à utiliser.",
  },
  {
    key: "home.service.partners.text",
    page: "Accueil — services",
    label: "Service partenaires — description",
    defaultValue: "Retrouvez les codes promo, liens de parrainage et demandes partenaires au même endroit.",
    multiline: true,
  },
  {
    key: "home.service.partners.stat",
    page: "Accueil — services",
    label: "Service partenaires — repère",
    defaultValue: "Codes actifs",
  },
  {
    key: "home.service.partners.bullet1",
    page: "Accueil — services",
    label: "Service partenaires — puce 1",
    defaultValue: "CID partenaire officiel",
  },
  {
    key: "home.service.partners.bullet2",
    page: "Accueil — services",
    label: "Service partenaires — puce 2",
    defaultValue: "Copie rapide des codes",
  },
  {
    key: "home.service.partners.bullet3",
    page: "Accueil — services",
    label: "Service partenaires — puce 3",
    defaultValue: "Demande de code ambassadeur",
  },
  {
    key: "home.service.offers.eyebrow",
    page: "Accueil — services",
    label: "Service offres — petit titre",
    defaultValue: "Offres & USDT",
  },
  {
    key: "home.service.offers.title",
    page: "Accueil — services",
    label: "Service offres — titre",
    defaultValue: "Promotions et services USDT clairs.",
  },
  {
    key: "home.service.offers.text",
    page: "Accueil — services",
    label: "Service offres — description",
    defaultValue: "Profitez du code BIENVENUE et consultez les conditions de rachat USDT avant de contacter DYNAMIK.",
    multiline: true,
  },
  {
    key: "home.service.offers.stat",
    page: "Accueil — services",
    label: "Service offres — repère",
    defaultValue: "565 F/USDT",
  },
  {
    key: "home.service.offers.bullet1",
    page: "Accueil — services",
    label: "Service offres — puce 1",
    defaultValue: "Code BIENVENUE",
  },
  {
    key: "home.service.offers.bullet2",
    page: "Accueil — services",
    label: "Service offres — puce 2",
    defaultValue: "Rachat et vente USDT",
  },
  {
    key: "home.service.offers.bullet3",
    page: "Accueil — services",
    label: "Service offres — puce 3",
    defaultValue: "Partenaires Turboexchange/Jones",
  },
  {
    key: "home.service.about.eyebrow",
    page: "Accueil — services",
    label: "Service à propos — petit titre",
    defaultValue: "À propos",
  },
  {
    key: "home.service.about.title",
    page: "Accueil — services",
    label: "Service à propos — titre",
    defaultValue: "L’histoire et la mission de DYNAMIK.",
  },
  {
    key: "home.service.about.text",
    page: "Accueil — services",
    label: "Service à propos — description",
    defaultValue: "Découvrez l’origine de DYNAMIK, sa mission et la vision portée par l’équipe.",
    multiline: true,
  },
  {
    key: "home.service.about.stat",
    page: "Accueil — services",
    label: "Service à propos — repère",
    defaultValue: "2020 → 2025",
  },
  {
    key: "home.service.about.bullet1",
    page: "Accueil — services",
    label: "Service à propos — puce 1",
    defaultValue: "Histoire DYNAMIK SHOP",
  },
  {
    key: "home.service.about.bullet2",
    page: "Accueil — services",
    label: "Service à propos — puce 2",
    defaultValue: "Fondateurs",
  },
  {
    key: "home.service.about.bullet3",
    page: "Accueil — services",
    label: "Service à propos — puce 3",
    defaultValue: "Mission et vision",
  },
  {
    key: "home.service.support.eyebrow",
    page: "Accueil — services",
    label: "Service support — petit titre",
    defaultValue: "Support",
  },
  {
    key: "home.service.support.title",
    page: "Accueil — services",
    label: "Service support — titre",
    defaultValue: "Réclamations et FAQ accessibles sans chercher.",
  },
  {
    key: "home.service.support.text",
    page: "Accueil — services",
    label: "Service support — description",
    defaultValue: "Trouvez une réponse rapide ou envoyez une réclamation suivie directement sur WhatsApp.",
    multiline: true,
  },
  {
    key: "home.service.support.stat",
    page: "Accueil — services",
    label: "Service support — repère",
    defaultValue: "24/7",
  },
  {
    key: "home.service.support.bullet1",
    page: "Accueil — services",
    label: "Service support — puce 1",
    defaultValue: "FAQ dédiée",
  },
  {
    key: "home.service.support.bullet2",
    page: "Accueil — services",
    label: "Service support — puce 2",
    defaultValue: "Formulaire réclamation",
  },
  {
    key: "home.service.support.bullet3",
    page: "Accueil — services",
    label: "Service support — puce 3",
    defaultValue: "Transmission WhatsApp",
  },
  {
    key: "trust.hero.eyebrow",
    page: "Confiance",
    label: "Confiance — petit titre",
    defaultValue: "Confiance avant paiement",
  },
  {
    key: "trust.hero.title",
    page: "Confiance",
    label: "Confiance — titre",
    defaultValue: "Des repères visibles pour décider sans hésiter.",
  },
  {
    key: "trust.hero.subtitle",
    page: "Confiance",
    label: "Confiance — description",
    defaultValue: "Avant de payer, vous voyez les informations essentielles : référence claire, estimation rapide, validation humaine et preuves anonymisées.",
    multiline: true,
  },
  {
    key: "trust.steps.eyebrow",
    page: "Confiance",
    label: "Fonctionnement — petit titre",
    defaultValue: "Comment ça marche",
  },
  {
    key: "trust.steps.title",
    page: "Confiance",
    label: "Fonctionnement — titre",
    defaultValue: "Le parcours expliqué en 4 étapes.",
  },
  {
    key: "trust.steps.subtitle",
    page: "Confiance",
    label: "Fonctionnement — description",
    defaultValue: "Vous savez quoi faire à chaque moment : remplir la demande, payer après validation, suivre la réception et recevoir la confirmation.",
    multiline: true,
  },
  {
    key: "trust.proofs.eyebrow",
    page: "Confiance",
    label: "Preuves — petit titre",
    defaultValue: "Preuves & avis",
  },
  {
    key: "trust.proofs.title",
    page: "Confiance",
    label: "Preuves — titre",
    defaultValue: "Des preuves concrètes avant le premier message WhatsApp.",
  },
  {
    key: "trust.proofs.subtitle",
    page: "Confiance",
    label: "Preuves — description",
    defaultValue: "Avis clients, captures anonymisées et indicateurs de suivi rendent le service plus concret tout en protégeant les informations sensibles.",
    multiline: true,
  },
  {
    key: "trust.team.eyebrow",
    page: "Confiance",
    label: "Équipe — petit titre",
    defaultValue: "Équipe DYNAMIK",
  },
  {
    key: "trust.team.title",
    page: "Confiance",
    label: "Équipe — titre",
    defaultValue: "Une équipe visible, pas un formulaire anonyme.",
  },
  {
    key: "trust.team.subtitle",
    page: "Confiance",
    label: "Équipe — description",
    defaultValue: "DYNAMIK s’appuie sur les opérations, le support et les partenaires terrain pour accompagner chaque demande.",
    multiline: true,
  },
  {
